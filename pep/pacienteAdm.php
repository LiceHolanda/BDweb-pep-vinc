...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="box-search">
        <input type="search" class="form-control w-25" placeholder="Buscar pacientes cadastrados no PEP" id="pesquisar">
...
<p style= "text-align: center; color: rgba(0,0,0,0.6); font-size: 13px; "> (Filtrar por prontuário, nome ou data de nascimento)
...
{
    $data = $_GET['search'];
    $sql = "SELECT * FROM paciente WHERE id LIKE '%$data%' or nome LIKE '%$data%' or data_nascimento LIKE '%$data%' ORDER BY id DESC";
}
else
{
...
echo "<p><br><u>Pacientes cadastrados no sistema:</u></p>";
...
<br>
    ...
    function searchData()
    {
        window.location = 'pacienteAdm.php?search='+search.value;
    }
        </script>
    </html>